...
Placeholder for stock-opname implementation summary.
...
- [Design Document](./design.md): Complete architecture and requirements
- [This Summary](./implementation-summary.md): Implementation details

defmodule VoileWeb.Dashboard.Settings.HolidayLive do
  ...
  def render(assigns) do
    ...
    <div class="space-y-6">
      <.header>
        ...
        <:actions>
          ...
          <.button phx-click="import_holidays" class="success-btn">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div class="bg-white rounded-lg shadow p-6">
          <div class="flex items-center">
            <div class="flex-shrink-0"><.icon name="hero-flag" class="h-8 w-8 text-green-600" /></div>
      ...
      <div class="bg-white shadow rounded-lg">
        ...
        <div class="px-4 py-5 sm:p-6">
          <div class="mb-4 flex items-center space-x-3">
            <label class="text-sm font-medium text-gray-700">Viewing schedule for</label>
                  ...
                  <%= if length(@holidays) == 0 do %>
                    <tr>
                      <td colspan="5" class="px-6 py-12 text-center text-sm text-gray-500">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">No holidays configured</h3>
    ...
    <%= if @show_import_modal do %>
      <.modal id="import-modal" show={@show_import_modal} on_cancel={JS.push("cancel_import")}>
        <div class="mt-3">

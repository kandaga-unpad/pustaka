            ...
            <div class="card bg-base-100 shadow-xl sticky top-4">
              <div class="card-body">
                ...
                <div class="space-y-4 text-sm">
                  <div>
                    <h3 class="font-bold mb-2">1. Download Template</h3>
                  ...
                  <div>
                    <h3 class="font-bold mb-2">2. Required Columns</h3>
                  ...
                  <div>
                    <h3 class="font-bold mb-2">3. Status Values</h3>
                  ...
                  <div>
                    <h3 class="font-bold mb-2">4. Access Levels</h3>
                  ...
                  <div>
                    <h3 class="font-bold mb-2">5. Available Properties</h3>
                  ...
                  <div>
                    <h3 class="font-bold mb-2">6. Items (Optional)</h3>

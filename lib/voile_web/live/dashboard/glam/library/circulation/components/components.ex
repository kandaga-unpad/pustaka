defmodule VoileWeb.Dashboard.Glam.Library.Circulation.Components do
      ...
      <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <%= if can?(@current_user, "circulation.return") do %>
          <button
            ...
            class="w-full inline-flex items-center justify-center px-4 py-2 border border-voile text-sm font-medium rounded-md shadow-sm bg-green-600 text-white hover:bg-green-700 transition-colors"
          >
        ...
        <%= if can?(@current_user, "members.lookup") do %>
          <button
            ...
            class="w-full inline-flex items-center justify-center px-4 py-2 border border-voile text-sm font-medium rounded-md shadow-sm bg-purple-600 text-white hover:bg-purple-700 transition-colors"
          >
    ...
    >
      <div class="space-y-4">
        <div class="flex items-start space-x-3">
          <div class="p-2 rounded-full bg-blue-100 text-blue-600 dark:bg-blue-700/10 dark:text-blue-300">
  ...
  def quick_return_modal(assigns) do
    ...
    >
      <div class="space-y-4">
        <div class="flex items-start space-x-3">
          <div class="p-2 rounded-full bg-green-100 text-green-600 dark:bg-green-700/10 dark:text-green-300">
        ...
        <%= if @quick_return_transaction do %>
          <div class="p-3 rounded-lg bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700">
            ...
            <div class="mt-1 text-lg font-semibold text-rose-600 dark:text-rose-300">
  ...
  def member_lookup_modal(assigns) do
    ...
    >
      <div class="space-y-4">
        <div class="flex items-start space-x-3">
          <div class="p-2 rounded-full bg-purple-100 text-purple-600 dark:bg-purple-700/10 dark:text-purple-300">
            ...
            <div class="flex items-start space-x-3">
              ...
              <div class="flex-1">
                ...
                <%= if @selected_member.user_type do %>
                  <div class="mt-2">
                    <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-blue-100 text-blue-800 dark:bg-blue-700/20 dark:text-blue-300">

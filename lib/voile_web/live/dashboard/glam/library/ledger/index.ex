                ...
                class={
                  if(
                    @selected_member.expiry_date &&
                      Date.compare(@selected_member.expiry_date, Date.utc_today()) == :lt,
                    do:
                      "px-8 py-3 rounded-lg font-semibold shadow-lg bg-gray-400 cursor-not-allowed text-gray-200",
                    else:
                      "px-8 py-3 rounded-lg font-semibold shadow-lg bg-green-600 hover:bg-green-700 text-white"
                  )
                }
              >

defmodule VoileWeb.PageLive.Home do
  ...
  def mount(params, _session, socket) do
    ...
    dashboard_stats = %{
      ...
      latest_collections: dashboard_stats.new_books || []
    }
  ...
  defp get_category_gradient_class(_), do: "voile-gradient"
  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash} current_scope={assigns[:current_scope]}>
      <section class="relative">
        ...
        <!-- GLAM Features Section -->
        <section class="max-w-7xl mx-auto py-12 px-4">
          <!-- GLAM Cards -->
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <div class="group h-full p-6 rounded-2xl bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 border-2 border-emerald-200 dark:border-emerald-800 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <ul class="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                ...
                <li class="flex items-start gap-2">
                  <.icon
                    name="hero-check-circle"
                    class="w-5 h-5 text-emerald-500 flex-shrink-0 mt-0.5"
                  /> <span>{gettext("Artist & creator tracking")}</span>
                </li>
              </ul>
            </div>
        ...
        <!-- Features Section -->
        <section class="max-w-7xl mx-auto py-12 px-4 bg-gray-50 dark:bg-gray-900/50">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            ...
            <.link navigate="/collections" class="block">
              <div class="group h-full p-6 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                <div class="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                  <.icon name="hero-book-open" class="w-8 h-8 text-white" />
                </div>
            ...
            <!-- Browse Items -->
            <.link navigate="/items" class="block">
              <div class="group h-full p-6 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                <div class="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
            ...
            <!-- E-Books -->
            <.link navigate={~p"/ebook"} class="block">
              <div class="group h-full p-6 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            ...
            <%= if assigns[:current_scope] && assigns[:current_scope].user do %>
              <.link navigate="/atrium" class="block">
                <div class="group h-full p-6 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                  <div class="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
            ...
            <% else %>
              <.link navigate="/register" class="block">
                <div class="group h-full p-6 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                  <div class="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
            ...
            <% end %>
            <!-- Advanced Search -->
            <.link navigate="/search" class="block">
              <div class="group h-full p-6 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                <div class="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-rose-500 to-pink-600 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
            ...
            <!-- About -->
            <.link navigate="/about" class="block">
              <div class="group h-full p-6 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            ...
            <%= if length(@dashboard_stats.node_collections) > 0 do %>
              <div class="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-4xl mx-auto mb-8">
                <%= for node <- @dashboard_stats.node_collections do %>
                  <.link navigate={"/collections?unit_id=#{node.id}"} class="block">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-2">
                      <div class="flex items-center gap-3">
                        ...
                        <div>
                          <p class="text-sm font-medium text-gray-800 dark:text-gray-200 truncate">
                            <%= if user.fullname do %>
                              {String.slice(user.fullname, 0..25)}{if String.length(user.fullname) >
                                                                        25,
                                                                      do: "..."}
                            <% else %>
          ...
          <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <%= if assigns[:current_scope] && assigns[:current_scope].user do %>
              ...
              <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  <.icon name="hero-home" class="w-5 h-5 mr-2" /> {gettext("Go to My Atrium")}
                </.link>
              </div>
            <% else %>
              ...
              <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <.link
                  ...
                  style={"color: #{@app_main_color};"}
                >
                  <.icon name="hero-user-plus" class="w-5 h-5 mr-2" /> {gettext("Create Account")}
                </.link>
                <.link
                  navigate="/login"
                  class="inline-flex items-center justify-center px-8 py-4 bg-white/20 text-white font-semibold rounded-lg shadow-lg hover:bg-white/30 transition-colors backdrop-blur-sm"
                ...
                <.link
                  navigate="/collections"
                  class="inline-flex items-center justify-center px-8 py-4 border-2 border-white/40 text-white font-semibold rounded-lg shadow-lg hover:bg-white/10 transition-colors backdrop-blur-sm"
                >
                  <.icon name="hero-book-open" class="w-5 h-5 mr-2" /> {gettext("Explore as Guest")}
                </.link>
              </div>
            <% end %>
          </div>

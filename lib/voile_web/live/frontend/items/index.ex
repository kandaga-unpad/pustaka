defmodule VoileWeb.Frontend.Items.Index do
  ...
  def mount(_params, _session, socket) do
    ...
    {:ok,
     ...
     |> assign(:search_query, "")
     |> assign(:filter_availability, "available")
  ...
  def handle_params(params, _uri, socket) do
    ...
    filter_availability = Map.get(params, "availability", "available")
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <% else %>
            ...
            <%= if length(@items) > 0 do %>
              <div class="bg-white dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-700 rounded-lg divide-y divide-gray-200 dark:divide-gray-700 mb-8">
                <div

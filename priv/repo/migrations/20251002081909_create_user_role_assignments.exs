defmodule Voile.Repo.Migrations.CreateUserRoleAssignments do
  ...
  def change do
    ...
    create index(:user_role_assignments, [:user_id, :glam_type])
    ...
    # Add check constraint for valid GLAM types
    create constraint(:user_role_assignments, :valid_glam_type,
             check:
               "glam_type IS NULL OR glam_type IN ('Gallery', 'Library', 'Archive', 'Museum')"
           )
  end
end

...
- [Catalog Module Guide](./CATALOG_MODULE_GUIDE.md) - Complete catalog documentation
- [Circulation Module Guide](./CIRCULATION_MODULE_GUIDE.md) - Complete circulation documentation
- [RBAC Guide](./RBAC_GUIDE.md) - Authorization system
- [Database Schema](../schema.md) - Database structure (if exists)
